...
salt-call vmware_vcenter_supervisor_compat.list_edge_cluster_compatibility \
...
salt-call vmware_vcenter_supervisor.disable_cluster cluster_id=domain-c9
```
...
salt-call vmware_vcenter_supervisor_service.get tkg.vsphere.vmware.com
salt-call vmware_vcenter_supervisor_service.list_versions tkg.vsphere.vmware.com
...
salt-call vmware_vcenter_supervisor_service.activate   tkg.vsphere.vmware.com
salt-call vmware_vcenter_supervisor_service.deactivate tkg.vsphere.vmware.com
```
...
```bash
salt-call vmware_vcenter_vm_class.list_
salt-call vmware_vcenter_vm_class.get guaranteed-small
```
...
```bash
salt-call vmware_vcenter_supervisor.list_namespaces
salt-call vmware_vcenter_supervisor.create_namespace \
    namespace_spec='{"cluster":"domain-c9","namespace":"team-a"}'
salt-call vmware_vcenter_supervisor.delete_namespace team-a
```

## Software lifecycle

```bash
salt-call vmware_vcenter_supervisor_software.list_
salt-call vmware_vcenter_supervisor_software.get domain-c9

salt-call vmware_vcenter_supervisor_software.upgrade domain-c9 \
