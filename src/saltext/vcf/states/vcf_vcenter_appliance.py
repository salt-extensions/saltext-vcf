...
# CEIP is not exposed at the vCenter-appliance layer on VCF 9.x. The
# equivalent state now lives at :mod:`saltext.vcf.states.vcf_sddc_ceip`
# (``vcf_sddc_ceip.disabled`` / ``vcf_sddc_ceip.enabled``).
