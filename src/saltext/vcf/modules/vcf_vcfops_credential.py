...
from saltext.vcf.clients import vcfops_credential as c

__virtualname__ = "vcf_vcfops_credential"
...
def delete(credential_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_credential.delete <credential_id>
...
def kinds_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_credential.kinds_list
