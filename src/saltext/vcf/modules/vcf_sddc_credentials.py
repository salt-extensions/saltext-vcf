...
from saltext.vcf.clients import sddc_credentials as r

__virtualname__ = "vcf_sddc_credentials"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_credentials.list_
...
def rotate(elements, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_credentials.rotate <elements>
