...
from saltext.vcf.clients import vcfops_supermetric as c

__virtualname__ = "vcf_vcfops_supermetric"
...
def list_(page=0, page_size=1000):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_supermetric.list_ <page> <page_size>
...
def get(supermetric_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_supermetric.get <supermetric_id>
...
def create(supermetric_spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_supermetric.create <supermetric_spec>
...
def update(supermetric_id, supermetric_spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_supermetric.update <supermetric_id> <supermetric_spec>
...
def delete(supermetric_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_supermetric.delete <supermetric_id>
