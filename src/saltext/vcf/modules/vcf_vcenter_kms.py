...
from saltext.vcf.clients import vcenter_kms as c

__virtualname__ = "vcf_vcenter_kms"
...
def get(provider_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_kms.get <provider_id>
...
def create(provider_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_kms.create <provider_spec>
...
def delete(provider_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_kms.delete <provider_id>
