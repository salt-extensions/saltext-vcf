...
from saltext.vcf.clients import nsx_nat as c

__virtualname__ = "vcf_nsx_nat"
...
def list_(t1, scope="USER", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.list_ <t1> <scope>
...
def get(rule, t1, scope="USER", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.get <rule> <t1> <scope>
...
def get_or_none(rule, t1, scope="USER", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.get_or_none <rule> <t1> <scope>
...
def create(rule, t1, scope="USER", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.create <rule> <t1> <scope>
...
def delete(rule, t1, scope="USER", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.delete <rule> <t1> <scope>
...
def list_t0(t0, scope="USER", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_nsx_nat.list_t0 <t0> <scope>
