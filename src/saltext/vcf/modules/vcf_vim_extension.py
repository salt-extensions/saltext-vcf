...
def get(key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_extension.get <key>
...
def get_or_none(key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_extension.get_or_none <key>
...
def register(key, version, description, company, profile=None, **fields):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_extension.register <key> <version> <description> <company>
...
def update(key, version=None, description=None, profile=None, **fields):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_extension.update <key> <version> <description>
...
def unregister(key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_extension.unregister <key>
