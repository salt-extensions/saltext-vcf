...
from saltext.vcf.clients import vcenter_tag as r
...
def assign(tag, object_type, object_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag.assign <tag> <object_type> <object_id>
...
def list_assigned(object_type, object_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag.list_assigned <object_type> <object_id>
