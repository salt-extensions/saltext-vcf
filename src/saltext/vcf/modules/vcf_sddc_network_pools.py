...
from saltext.vcf.clients import sddc_network_pools as c

__virtualname__ = "vcf_sddc_network_pools"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_network_pools.list_
...
def get(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_network_pools.get <pool_id>
...
def create(network_pool_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_network_pools.create <network_pool_spec>
...
def delete(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_sddc_network_pools.delete <pool_id>
