...
from saltext.vcf.clients import vcfops_policy as c

__virtualname__ = "vcf_vcfops_policy"
...
def get(policy_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_policy.get <policy_id>
...
def notification_rules_list():
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_policy.notification_rules_list
