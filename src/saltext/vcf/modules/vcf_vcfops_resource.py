...
from saltext.vcf.clients import vcfops_resource as c

__virtualname__ = "vcf_vcfops_resource"
...
def list_(page=0, page_size=1000, **filters):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_resource.list_ <page> <page_size>
...
def get(resource_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_resource.get <resource_id>
...
def relationships(resource_id, **filters):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_resource.relationships <resource_id>
...
def stats(resource_id, **filters):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcfops_resource.stats <resource_id>
