...
from saltext.vcf.clients import vim_vm_guest as c

__virtualname__ = "vcf_vim_vm_guest"
...
def delete_directory(vm, path, username=None, password=None, recursive=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_vm_guest.delete_directory vm-100 /tmp/build recursive=true username=root password='<pw>'
    """
...
def move_file(vm, src_path, dst_path, username=None, password=None, overwrite=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_vm_guest.move_file vm-100 /root/a.txt /root/b.txt username=root password='<pw>'
    """
    return c.move_file(
        __opts__,
        vm,
