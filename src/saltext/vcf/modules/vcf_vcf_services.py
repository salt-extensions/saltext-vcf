...
from saltext.vcf.clients import sddc_vcf_services as c

__virtualname__ = "vcf_vcf_services"
...
def get(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcf_services.get <service_id>
...
def get_by_name(name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcf_services.get_by_name <name>
...
def status_map(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcf_services.status_map
