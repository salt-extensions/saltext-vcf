...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_vm_class.list_
...
def get(class_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_vm_class.get <class_id>
...
def create(class_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_vm_class.create <class_spec>
...
def update(class_id, class_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_vm_class.update <class_id> <class_spec>
...
def delete(class_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_vm_class.delete <class_id>
