...
def drs_vm_list(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.drs_vm_list <cluster>
    """
...
def drs_vm_set(cluster, vm_moid, behavior, enabled=True, profile=None):
    ...
    *behavior*: ``manual`` | ``partiallyAutomated`` | ``fullyAutomated`` | ``disabled``.
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.drs_vm_set <cluster> <vm_moid> manual
    """
...
def drs_vm_remove(cluster, vm_moid, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.drs_vm_remove <cluster> <vm_moid>
    """
...
def ha_vm_list(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.ha_vm_list <cluster>
    """
...
def ha_vm_set(cluster, vm_moid, restart_priority=None, isolation_response=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.ha_vm_set <cluster> <vm_moid> restart_priority=high
    """
    return c.ha_vm_set(
        __opts__,
        cluster,
...
def ha_vm_remove(cluster, vm_moid, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.ha_vm_remove <cluster> <vm_moid>
    """
...
def dpm_host_list(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.dpm_host_list <cluster>
    """
...
def dpm_host_set(cluster, host_moid, behavior, enabled=True, profile=None):
    ...
    *behavior*: ``manual`` | ``automated``.
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.dpm_host_set <cluster> <host_moid> manual
    """
...
def dpm_host_remove(cluster, host_moid, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_cluster_overrides.dpm_host_remove <cluster> <host_moid>
    """
