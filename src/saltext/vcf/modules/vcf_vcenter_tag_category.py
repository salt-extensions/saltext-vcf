...
from saltext.vcf.clients import vcenter_tag_category as r
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag_category.list_
    """
...
def get(category_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag_category.get <category_id>
    """
...
def create(name, cardinality="SINGLE", description="", associable_types=None, profile=None):
    ...
    *associable_types* is a list of inventory object types this category's tags
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag_category.create owner cardinality=SINGLE associable_types='["VirtualMachine"]'
    """
    return r.create(
        __opts__,
        name,
...
def update(category_id, spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag_category.update <category_id> spec='{"description": "new"}'
    """
...
def delete(category_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_tag_category.delete <category_id>
    """
