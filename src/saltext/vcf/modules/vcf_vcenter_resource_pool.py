...
from saltext.vcf.clients import vcenter_resource_pool as c

__virtualname__ = "vcf_vcenter_resource_pool"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_resource_pool.list_
...
def get(rp_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_resource_pool.get <rp_id>
...
def create(name, parent, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_resource_pool.create <name> <parent>
...
def delete(rp_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_resource_pool.delete <rp_id>
...
def tree(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_resource_pool.tree
