...
from saltext.vcf.clients import vim_host_acceptance as c

__virtualname__ = "vcf_vim_host_acceptance"
...
def get(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_host_acceptance.get <host>
    """
...
def set_(host, level, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vim_host_acceptance.set_ <host> community
    """
