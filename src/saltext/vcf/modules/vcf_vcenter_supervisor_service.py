...
from saltext.vcf.clients import vcenter_supervisor_service as c

__virtualname__ = "vcf_vcenter_supervisor_service"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.list_
...
def get(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.get <service_id>
...
def list_versions(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.list_versions <service_id>
...
def get_version(service_id, version, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.get_version <service_id> <version>
...
def create(service_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.create <service_spec>
...
def activate(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.activate <service_id>
...
def deactivate(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.deactivate <service_id>
...
def delete(service_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vcf_vcenter_supervisor_service.delete <service_id>
