...
from saltext.vmware.clients import vim_host_certificate as c

__virtualname__ = "vmware_vim_host_certificate"
...
def info(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_certificate.info <host>
    """
...
def generate_csr(host, useip=True, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_certificate.generate_csr <host>
    """
...
def install_cert(host, cert_pem, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_certificate.install_cert <host> <cert_pem>
    """
...
def refresh_cert(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_certificate.refresh_cert <host>
    """
...
def refresh_ca_bundle(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_certificate.refresh_ca_bundle <host>
    """
