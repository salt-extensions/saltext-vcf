...
from saltext.vmware.clients import vim_datastore_cluster as c

__virtualname__ = "vmware_vim_datastore_cluster"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.list_
    """
...
def get(name_or_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.get <name>
    """
...
def create(name, datacenter, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.create prod-storage Datacenter
    """
...
def delete(name_or_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.delete <name>
    """
...
def add_datastore(pod, datastore, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.add_datastore <pod> <datastore>
    """
...
def remove_datastore(pod, datastore, datacenter, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.remove_datastore <pod> <datastore> <datacenter>
    """
...
def sdrs_get(pod, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.sdrs_get <pod>
    """
...
def sdrs_set(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.sdrs_set <pod> enabled=True automation_level=automated
    """
    return c.sdrs_set(
        __opts__,
        pod,
...
def sdrs_vm_override_list(pod, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.sdrs_vm_override_list <pod>
    """
...
def sdrs_vm_override_set(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_cluster.sdrs_vm_override_set <pod> <vm_moid> behavior=manual
    """
