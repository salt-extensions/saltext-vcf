...
from saltext.vmware.clients import sddc_avn as avn
from saltext.vmware.clients import sddc_system as system
from saltext.vmware.clients import sddc_users as users

__virtualname__ = "vmware_sddc_system"
...
def system_info(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.system_info
    """
...
def list_personalities(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.list_personalities
    """
...
def get_personality(personality_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.get_personality <personality-id>
    """
...
def list_users(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.list_users
    """
...
def list_roles(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.list_roles
    """
...
def add_users(user_specs, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.add_users '[{...}]'
    """
...
def delete_user(user_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.delete_user <user-id>
    """
...
def list_avns(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_system.list_avns
    """
