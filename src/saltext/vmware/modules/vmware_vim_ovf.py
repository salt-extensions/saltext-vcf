...
from saltext.vmware.clients import vim_ovf as c

__virtualname__ = "vmware_vim_ovf"
...
def descriptor(vm, ovf_name=None, description="", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_ovf.descriptor <vm>
...
def export(vm, output_dir, ovf_name=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_ovf.export <vm> /tmp/ovf-out
