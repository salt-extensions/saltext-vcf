...
from saltext.vmware.clients import vcfops_report as c

__virtualname__ = "vmware_vcfops_report"
...
def list_(page=0, page_size=1000):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_report.list_ <page> <page_size>
...
def get(report_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_report.get <report_id>
...
def generate(report_spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_report.generate <report_spec>
...
def download(report_id, fmt="PDF"):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_report.download <report_id> <fmt>
...
def delete(report_id):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_report.delete <report_id>
