...
__virtualname__ = "vmware_vcenter_content_library"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.list_
...
def get(library_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.get <library_id>
...
def list_local(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.list_local
...
def create_local(name, storage_backings, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.create_local <name> <storage_backings>
...
def delete_local(library_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.delete_local <library_id>
...
def list_subscribed(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.list_subscribed
...
def create_subscribed(name, subscription_url, storage_backings, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.create_subscribed <name> <subscription_url> <storage_backings>
...
def list_items(library_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.list_items <library_id>
...
def get_item(item_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.get_item <item_id>
...
def delete_item(item_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.delete_item <item_id>
...
def update_local(library_id, spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_local <library_id> spec='{"name": "new"}'
    """
...
def update_subscribed(library_id, spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_subscribed <library_id> spec='{...}'
    """
...
def sync_subscribed(library_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.sync_subscribed <library_id>
    """
...
def publish_library(library_id, subscriptions=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.publish_library <library_id>
    """
...
def find_libraries(name=None, type=None, profile=None):  # pylint: disable=redefined-builtin
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.find_libraries name=base type=LOCAL
    """
...
def create_item(library_id, name, type, profile=None, **spec):  # pylint: disable=redefined-builtin
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.create_item <library_id> myitem ovf
    """
...
def update_item(item_id, spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_item <item_id> spec='{"name": "new"}'
    """
...
def find_items(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.find_items library_id=<id> name=foo
    """
...
def update_session_create(item_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_create <item_id>
    """
...
def update_session_get(session_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_get <session_id>
    """
...
def update_session_complete(session_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_complete <session_id>
    """
...
def update_session_cancel(session_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_cancel <session_id>
    """
...
def update_session_fail(session_id, error, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_fail <session_id> 'error message'
    """
...
def update_session_keep_alive(session_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_keep_alive <session_id>
    """
...
def update_session_add_file(session_id, name, source_type="PUSH", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_add_file <session_id> disk.vmdk
    """
...
def update_session_list_files(session_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.update_session_list_files <session_id>
    """
...
def ovf_deploy(library_item_id, deployment_target, deployment_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.ovf_deploy <item_id> '{"resource_pool_id": "..."}' '{"name": "vm-1"}'
    """
    return c.ovf_deploy(
...
def ovf_filter(library_item_id, deployment_target, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.ovf_filter <item_id> '{"resource_pool_id": "..."}'
    """
...
def ovf_create_from_vm(vm_id, create_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.ovf_create_from_vm <vm_id> '{...}'
    """
...
def vm_template_get(item_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.vm_template_get <item_id>
    """
...
def vm_template_create(create_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.vm_template_create '{...}'
    """
...
def vm_template_deploy(item_id, deploy_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_content_library.vm_template_deploy <item_id> '{...}'
    """
