...
from saltext.vmware.clients import sddc_cluster as r

__virtualname__ = "vmware_sddc_cluster"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_cluster.list_
...
def get(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_cluster.get <cluster>
...
def create(cluster_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_cluster.create <cluster_spec>
...
def delete(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_cluster.delete <cluster>
