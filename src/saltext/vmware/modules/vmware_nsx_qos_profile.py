...
from saltext.vmware.clients import nsx_qos_profile as c

__virtualname__ = "vmware_nsx_qos_profile"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_qos_profile.list_
    """
...
def get(qos_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_qos_profile.get <qos_profile>
    """
...
def create(qos_profile, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_qos_profile.create <id> class_of_service=3 dscp='{"mode":"TRUSTED","priority":0}'
    """
...
def delete(qos_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_qos_profile.delete <qos_profile>
    """
