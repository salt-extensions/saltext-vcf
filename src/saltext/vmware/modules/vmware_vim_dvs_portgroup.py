...
from saltext.vmware.clients import vim_dvs_portgroup as c

__virtualname__ = "vmware_vim_dvs_portgroup"
...
def list_(dvs, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.list_ prod-dvs
    """
...
def get(dvs, name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.get prod-dvs prod-web
    """
...
def get_or_none(dvs, name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.get_or_none prod-dvs prod-web
    """
...
def create_vlan(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.create_vlan prod-dvs prod-web vlan_id=100
    """
...
def create_trunk(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.create_trunk prod-dvs trunk-uplink '[[100,200]]'
    """
...
def reconfigure(dvs, name, vlan_id=None, num_ports=None, promiscuous=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.reconfigure prod-dvs prod-web vlan_id=200
    """
...
def delete(dvs, name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_dvs_portgroup.delete prod-dvs prod-web
    """
