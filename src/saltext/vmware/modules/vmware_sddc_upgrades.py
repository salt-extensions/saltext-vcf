...
from saltext.vmware.clients import sddc_upgrades as c

__virtualname__ = "vmware_sddc_upgrades"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_upgrades.list_
...
def get(upgrade_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_upgrades.get <upgrade_id>
...
def start(upgrade_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_upgrades.start <upgrade_spec>
