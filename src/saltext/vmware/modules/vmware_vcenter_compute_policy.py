...
from saltext.vmware.clients import vcenter_compute_policy as c

__virtualname__ = "vmware_vcenter_compute_policy"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_compute_policy.list_
    """
...
def get(policy_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_compute_policy.get <policy_id>
    """
...
def create(capability, profile=None, **spec):
    ...
    *capability* is the policy capability identifier — e.g.
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_compute_policy.create <capability> name=anti-affinity-prod
    """
...
def delete(policy_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_compute_policy.delete <policy_id>
    """
