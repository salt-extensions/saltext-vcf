...
from saltext.vmware.clients import installer_system as c

__virtualname__ = "vmware_installer_system"
...
def status(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.status
    """
...
def version(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.version
    """
...
def registration(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.registration
    """
...
def dns_config(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.dns_config
    """
...
def update_dns_config(dns_servers, search_domains=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.update_dns_config '[10.0.0.1]'
    """
...
def ntp_config(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.ntp_config
    """
...
def update_ntp_config(ntp_servers, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.update_ntp_config '[time.example.com]'
    """
...
def identity_broker(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.identity_broker
    """
...
def sddc_manager(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_system.sddc_manager
    """
