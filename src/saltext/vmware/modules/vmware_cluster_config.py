...
Quick reference::
    ...
    # Status
    salt-call vmware_cluster_config.enablement_get domain-c9
    salt-call vmware_cluster_config.configuration_get domain-c9
    salt-call vmware_cluster_config.schema_get domain-c9

    # Drafts
    salt-call vmware_cluster_config.drafts_list domain-c9
    salt-call vmware_cluster_config.draft_create domain-c9
    salt-call vmware_cluster_config.draft_get domain-c9 <draft_id>
    salt-call vmware_cluster_config.draft_update_configuration domain-c9 <draft_id> '<json>'
...
def enablement_get(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.enablement_get <cluster>
...
def schema_get(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.schema_get <cluster>
...
def configuration_get(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.configuration_get <cluster>
...
def drafts_list(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.drafts_list <cluster>
...
def draft_create(cluster, body=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_create <cluster> <body>
...
def draft_get(cluster, draft_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_get <cluster> <draft_id>
...
def draft_get_configuration(cluster, draft_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_get_configuration <cluster> <draft_id>
...
def draft_update_configuration(cluster, draft_id, body, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_update_configuration <cluster> <draft_id> <body>
...
def draft_delete(cluster, draft_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_delete <cluster> <draft_id>
...
def draft_apply(cluster, draft_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.draft_apply <cluster> <draft_id>
...
def last_apply_result(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.last_apply_result <cluster>
...
def last_compliance_result(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_cluster_config.last_compliance_result <cluster>
