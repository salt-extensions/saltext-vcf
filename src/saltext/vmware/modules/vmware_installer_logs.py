...
from saltext.vmware.clients import installer_logs as c

__virtualname__ = "vmware_installer_logs"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_logs.list_
    """
...
def get(bundle_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_logs.get <bundle_id>
    """
...
def generate(profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_logs.generate
    """
...
def delete(bundle_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_logs.delete <bundle_id>
    """
