...
from saltext.vmware.clients import vcfops_collector as c

__virtualname__ = "vmware_vcfops_collector"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.list_
...
def get(collector_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.get <collector_id>
...
def delete(collector_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.delete <collector_id>
...
def groups_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.groups_list
...
def groups_get(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.groups_get <group_id>
...
def groups_create(group_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.groups_create <group_spec>
...
def groups_update(group_id, group_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.groups_update <group_id> <group_spec>
...
def groups_delete(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_collector.groups_delete <group_id>
