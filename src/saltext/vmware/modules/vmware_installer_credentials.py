...
from saltext.vmware.clients import installer_credentials as c

__virtualname__ = "vmware_installer_credentials"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_credentials.list_
    """
...
def get(password_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_credentials.get <password_id>
    """
...
def rotate(password_id, new_password, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_installer_credentials.rotate <password_id> <new_password>
    """
