...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_host.list_
...
def get(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_host.get <host>
...
def enter_maintenance(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_host.enter_maintenance <host>
...
def exit_maintenance(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_host.exit_maintenance <host>
