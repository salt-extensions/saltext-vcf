...
def lockdown_get(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.lockdown_get
...
def lockdown_set(mode, exception_users=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.lockdown_set <mode> <exception_users>
...
def enter_maintenance(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.enter_maintenance
...
def exit_maintenance(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.exit_maintenance
...
def reboot(force=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.reboot <force>
...
def shutdown(force=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_esxi_host.shutdown <force>
