...
from saltext.vmware.clients import nsx_ip_pool as c

__virtualname__ = "vmware_nsx_ip_pool"
...
def get(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.get <pool_id>
...
def create(pool_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.create <pool_id>
...
def delete(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.delete <pool_id>
...
def list_subnets(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.list_subnets <pool_id>
...
def create_subnet(pool_id, subnet_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.create_subnet <pool_id> <subnet_id>
...
def delete_subnet(pool_id, subnet_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.delete_subnet <pool_id> <subnet_id>
...
def list_allocations(pool_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ip_pool.list_allocations <pool_id>
