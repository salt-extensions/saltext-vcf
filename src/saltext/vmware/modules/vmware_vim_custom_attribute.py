...
from saltext.vmware.clients import vim_custom_attribute as c

__virtualname__ = "vmware_vim_custom_attribute"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_custom_attribute.list_
...
def get(name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_custom_attribute.get <name>
...
def add(name, managed_object_type=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_custom_attribute.add <name> <managed_object_type>
...
def remove(name_or_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_custom_attribute.remove <name_or_key>
...
def set_value(entity_mo_id, name, value, entity_type=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_custom_attribute.set_value <entity_mo_id> <name> <value> <entity_type>
