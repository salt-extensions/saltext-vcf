...
from saltext.vmware.clients import vim_infra_profile as c

__virtualname__ = "vmware_vim_infra_profile"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_infra_profile.list_
    """
...
def get(host_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_infra_profile.get <host_profile>
    """
...
def export(host_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_infra_profile.export <host_profile>
    """
...
def check_compliance(host_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_infra_profile.check_compliance <host_profile>
    """
