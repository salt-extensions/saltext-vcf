...
from saltext.vmware.clients import nsx_ids as c

__virtualname__ = "vmware_nsx_ids"
...
def get_global_config(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_global_config
    """
...
def set_global_config(profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.set_global_config auto_update=True
    """
...
def list_cluster_configs(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.list_cluster_configs
    """
...
def get_cluster_config(cluster_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_cluster_config <cluster_id>
    """
...
def set_cluster_config(cluster_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.set_cluster_config <cluster_id> ids_enabled=True
    """
...
def list_profiles(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.list_profiles
    """
...
def get_profile(profile_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_profile <profile_id>
    """
...
def create_profile(profile_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.create_profile <profile_id> severity='["CRITICAL"]'
    """
...
def delete_profile(profile_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.delete_profile <profile_id>
    """
...
def list_signatures(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.list_signatures
    """
...
def get_signature(signature_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_signature <signature_id>
    """
...
def list_policies(domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.list_policies
    """
...
def get_policy(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_policy <policy>
    """
...
def create_policy(policy, domain="default", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.create_policy <policy> category=Infrastructure
    """
...
def delete_policy(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.delete_policy <policy>
    """
...
def list_rules(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.list_rules <policy>
    """
...
def get_rule(rule, policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.get_rule <rule> <policy>
    """
...
def create_rule(rule, policy, domain="default", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.create_rule <rule> <policy> action=DETECT ids_profiles='["..."]'
    """
...
def delete_rule(rule, policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ids.delete_rule <rule> <policy>
    """
