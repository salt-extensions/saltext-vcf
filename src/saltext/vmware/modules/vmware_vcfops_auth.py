...
__virtualname__ = "vmware_vcfops_auth"
...
def sources_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.sources_list
...
def sources_get(source_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.sources_get <source_id>
...
def roles_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.roles_list
...
def roles_get(role_name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.roles_get <role_name>
...
def roles_create(role_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.roles_create <role_spec>
...
def roles_delete(role_name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.roles_delete <role_name>
...
def privileges_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.privileges_list
...
def users_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.users_list
...
def users_get(user_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.users_get <user_id>
...
def users_create(user_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.users_create <user_spec>
...
def users_update(user_id, user_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.users_update <user_id> <user_spec>
...
def users_delete(user_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.users_delete <user_id>
...
def usergroups_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.usergroups_list
...
def usergroups_get(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.usergroups_get <group_id>
...
def usergroups_create(group_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.usergroups_create <group_spec>
...
def usergroups_delete(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_auth.usergroups_delete <group_id>
