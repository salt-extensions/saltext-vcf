...
from saltext.vmware.clients import fleet_password as c

__virtualname__ = "vmware_fleet_password"
...
def list_accounts(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.list_accounts
    """
...
def get_account(account_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.get_account <account_key>
    """
...
def get_password(account_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.get_password <account_key>
    """
...
def set_password(account_key, new_password, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.set_password <account_key> <new_password>
    """
...
def rotate(account_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.rotate <account_key>
    """
...
def history(account_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_fleet_password.history <account_key>
    """
