...
from saltext.vmware.clients import vim_vm_disk as c

__virtualname__ = "vmware_vim_vm_disk"
...
def list_(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_disk.list_ vm-100
    """
...
def add(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_disk.add vm-100 50 thin=true
    """
    return c.add(
        __opts__,
        vm,
...
def resize(vm, disk_key, size_gb, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_disk.resize vm-100 2000 100
    """
...
def remove(vm, disk_key, destroy_files=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_disk.remove vm-100 2000 destroy_files=false
    """
