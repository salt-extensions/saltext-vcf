...
from saltext.vmware.clients import nsx_edge_cluster as c

__virtualname__ = "vmware_nsx_edge_cluster"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.list_
...
def get(cluster_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.get <cluster_id>
...
def create(body, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.create <body>
...
def update(cluster_id, body, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.update <cluster_id> <body>
...
def delete(cluster_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.delete <cluster_id>
...
def state(cluster_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_edge_cluster.state <cluster_id>
