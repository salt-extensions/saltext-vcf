...
from saltext.vmware.clients import vim_vm_features as f

__virtualname__ = "vmware_vim_vm_features"
...
def get_features(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_features.get_features <vm>
    """
...
def set_features(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_features.set_features <vm> cpu_hot_add=True nested_hv=True
    """
...
def upgrade_hardware(vm, version=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_features.upgrade_hardware <vm> version=vmx-21
    """
