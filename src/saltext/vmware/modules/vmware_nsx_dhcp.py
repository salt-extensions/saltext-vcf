...
from saltext.vmware.clients import nsx_dhcp as c

__virtualname__ = "vmware_nsx_dhcp"
...
def server_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.server_list
...
def server_get(server_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.server_get <server_id>
...
def server_create(server_id, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.server_create <server_id>
...
def server_delete(server_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.server_delete <server_id>
...
def relay_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.relay_list
...
def relay_get(relay_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.relay_get <relay_id>
...
def relay_create(relay_id, server_addresses, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.relay_create <relay_id> <server_addresses>
...
def relay_delete(relay_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_dhcp.relay_delete <relay_id>
