...
def list_(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_firewall_rule.list_ <policy> <domain>
...
def get(rule, policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_firewall_rule.get <rule> <policy> <domain>
...
def create(rule, policy, domain="default", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_firewall_rule.create <rule> <policy> <domain>
...
def delete(rule, policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_firewall_rule.delete <rule> <policy> <domain>
