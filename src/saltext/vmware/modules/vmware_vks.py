...
(``pip install 'saltext.vmware[vks]'``) to get the runtime dependency.
"""
...
def fetch_kubeconfig(cluster_id, path=None, namespace=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vks.fetch_kubeconfig <cluster_id> <path> <namespace>
...
def saltext_kubernetes_available():
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vks.saltext_kubernetes_available
