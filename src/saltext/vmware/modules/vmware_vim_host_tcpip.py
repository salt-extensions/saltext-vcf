...
from saltext.vmware.clients import vim_host_tcpip as c

__virtualname__ = "vmware_vim_host_tcpip"
...
def list_(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_tcpip.list_ <host>
    """
...
def get(host, stack_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_tcpip.get <host> defaultTcpipStack
    """
...
def update(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_tcpip.update <host> defaultTcpipStack dns_servers='[10.0.0.1]'
    """
    return c.update(
        __opts__,
        host,
