...
from saltext.vmware.clients import vim_vm_power as c
from saltext.vmware.clients import vim_vm_tools as t

__virtualname__ = "vmware_vim_vm_power"
...
def get_power_state(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.get_power_state <vm-name-or-moid>
    """
...
def power_on(vm, host=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.power_on <vm>
    """
...
def power_off(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.power_off <vm>
    """
...
def shutdown_guest(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.shutdown_guest <vm>
    """
...
def reboot_guest(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.reboot_guest <vm>
    """
...
def standby_guest(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.standby_guest <vm>
    """
...
def reset(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.reset <vm>
    """
...
def suspend(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.suspend <vm>
    """
...
def get_tools_status(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.get_tools_status <vm>
    """
...
def upgrade_tools(vm, installer_options="", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.upgrade_tools <vm>
    """
...
def mount_tools_installer(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.mount_tools_installer <vm>
    """
...
def unmount_tools_installer(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_power.unmount_tools_installer <vm>
    """
