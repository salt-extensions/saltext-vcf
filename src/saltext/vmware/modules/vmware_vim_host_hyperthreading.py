...
from saltext.vmware.clients import vim_host_hyperthreading as c

__virtualname__ = "vmware_vim_host_hyperthreading"
...
def get(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_hyperthreading.get <host>
    """
...
def enable(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_hyperthreading.enable <host>
    """
...
def disable(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_hyperthreading.disable <host>
    """
