...
from saltext.vmware.clients import vim_vm_console as c

__virtualname__ = "vmware_vim_vm_console"
...
def screenshot(vm, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_console.screenshot <vm>
    """
...
def send_keys(vm, keys, profile=None):
    ...
    *keys* is a list of key names (``enter``, ``f2``, ``a``, etc.) or HID ints.
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_console.send_keys <vm> '[f2]'
    """
