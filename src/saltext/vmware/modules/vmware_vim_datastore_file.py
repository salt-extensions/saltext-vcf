...
__virtualname__ = "vmware_vim_datastore_file"
...
def list_(datacenter, datastore, path="", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.list_ <datacenter> <datastore> <path>
...
def mkdir(datacenter, datastore, path, create_parents=True, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.mkdir <datacenter> <datastore> <path>
...
def delete(datacenter, datastore, path, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.delete <datacenter> <datastore> <path>
...
def move(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.move <src_dc> <src_ds> <src_path> <dst_dc> <dst_ds> <dst_path>
...
def upload(datacenter, datastore, local_path, ds_path, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.upload <dc> <ds> <local_path> <ds_path>
...
def download(datacenter, datastore, ds_path, local_path, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_datastore_file.download <dc> <ds> <ds_path> <local_path>
