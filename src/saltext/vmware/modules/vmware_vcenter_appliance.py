...
def services_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.services_list
...
def services_get(service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.services_get <service>
...
def services_start(service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.services_start <service>
...
def services_stop(service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.services_stop <service>
...
def services_restart(service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.services_restart <service>
...
def version(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.version
...
def health_system(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.health_system
...
def dns_get(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.dns_get
...
def dns_set(servers, mode="is_static", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.dns_set <servers> <mode>
...
def logging_forwarding_get(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.logging_forwarding_get
...
def logging_forwarding_set(servers, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_appliance.logging_forwarding_set <servers>
