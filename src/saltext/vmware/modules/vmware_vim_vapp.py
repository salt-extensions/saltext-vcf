...
from saltext.vmware.clients import vim_vapp as c

__virtualname__ = "vmware_vim_vapp"
...
def create(name, parent_resource_pool, annotation=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.create <name> <parent_resource_pool>
    """
...
def power_on(vapp, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.power_on <vapp>
    """
...
def power_off(vapp, force=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.power_off <vapp>
    """
...
def suspend(vapp, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.suspend <vapp>
    """
...
def delete(vapp, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.delete <vapp>
    """
...
def update(vapp, annotation=None, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vapp.update <vapp> annotation='new annotation'
    """
