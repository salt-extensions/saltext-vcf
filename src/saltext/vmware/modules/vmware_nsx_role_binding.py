...
__virtualname__ = "vmware_nsx_role_binding"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_role_binding.list_
...
def get(binding_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_role_binding.get <binding_id>
...
def create(name, type_, roles, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_role_binding.create <name> <type_> <roles>
...
def update(binding_id, body, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_role_binding.update <binding_id> <body>
...
def delete(binding_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_role_binding.delete <binding_id>
