...
from saltext.vmware.clients import nsx_ipsec_vpn as vpn

__virtualname__ = "vmware_nsx_ipsec_vpn"
...
def list_ike_profiles(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.list_ike_profiles
    """
...
def get_ike_profile(ike_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.get_ike_profile <ike_profile>
    """
...
def create_ike_profile(ike_profile, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.create_ike_profile <ike_profile> ike_version=IKE_V2
    """
...
def delete_ike_profile(ike_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.delete_ike_profile <ike_profile>
    """
...
def list_tunnel_profiles(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.list_tunnel_profiles
    """
...
def get_tunnel_profile(tunnel_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.get_tunnel_profile <tunnel_profile>
    """
...
def create_tunnel_profile(tunnel_profile, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.create_tunnel_profile <tunnel_profile>
    """
...
def delete_tunnel_profile(tunnel_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.delete_tunnel_profile <tunnel_profile>
    """
...
def list_dpd_profiles(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.list_dpd_profiles
    """
...
def get_dpd_profile(dpd_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.get_dpd_profile <dpd_profile>
    """
...
def create_dpd_profile(dpd_profile, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.create_dpd_profile <dpd_profile>
    """
...
def delete_dpd_profile(dpd_profile, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.delete_dpd_profile <dpd_profile>
    """
...
def list_services(tier0, locale, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.list_services <tier0> <locale>
    """
...
def get_service(tier0, locale, service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.get_service <tier0> <locale> <service>
    """
...
def create_service(tier0, locale, service, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.create_service <tier0> <locale> <service> enabled=True
    """
...
def delete_service(tier0, locale, service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.delete_service <tier0> <locale> <service>
    """
...
def list_sessions(tier0, locale, service, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.list_sessions <tier0> <locale> <service>
    """
...
def get_session(tier0, locale, service, session, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.get_session <tier0> <locale> <service> <session>
    """
...
def create_session(tier0, locale, service, session, resource_type, profile=None, **spec):
    ...
    *resource_type* is ``PolicyBasedIPSecVpnSession`` or ``RouteBasedIPSecVpnSession``.
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.create_session <t0> <loc> <svc> <sess> PolicyBasedIPSecVpnSession
    """
...
def delete_session(tier0, locale, service, session, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_ipsec_vpn.delete_session <tier0> <locale> <service> <session>
    """
