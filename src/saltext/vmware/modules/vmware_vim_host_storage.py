...
from saltext.vmware.clients import vim_host_storage as c

__virtualname__ = "vmware_vim_host_storage"
...
def rescan_all_hba(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_storage.rescan_all_hba <host>
    """
...
def rescan_vmfs(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_storage.rescan_vmfs <host>
    """
...
def refresh(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_storage.refresh <host>
    """
