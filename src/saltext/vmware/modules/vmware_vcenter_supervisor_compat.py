...
from saltext.vmware.clients import vcenter_supervisor_compat as c

__virtualname__ = "vmware_vcenter_supervisor_compat"
...
def list_cluster_compatibility(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_supervisor_compat.list_cluster_compatibility
...
def list_dvs_compatibility(cluster_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_supervisor_compat.list_dvs_compatibility <cluster_id>
...
def list_edge_cluster_compatibility(cluster_id, distributed_switch, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_supervisor_compat.list_edge_cluster_compatibility <cluster_id> <distributed_switch>
...
def get_cluster_size_info(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcenter_supervisor_compat.get_cluster_size_info
