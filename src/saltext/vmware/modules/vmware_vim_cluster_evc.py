...
def get(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_cluster_evc.get <cluster>
    """
...
def configure(cluster, evc_mode_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_cluster_evc.configure <cluster> intel-sandybridge
    """
...
def disable(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_cluster_evc.disable <cluster>
    """
...
def check(cluster, evc_mode_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_cluster_evc.check <cluster> intel-sandybridge
    """
