...
__virtualname__ = "vmware_nsx_segment"
...
def get(segment, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_segment.get <segment>
...
def create(segment, profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_segment.create <segment>
...
def delete(segment, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_segment.delete <segment>
