...
def list_(entity_ref, inherited=True, profile=None):
    ...
    *entity_ref* is a bare MoID (``"vm-100"``) or ``"<type>:<moid>"``.
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_permission.list_ vm-100
        salt '*' vmware_vim_permission.list_ VirtualMachine:vm-100 inherited=false
    """
...
def set_(entity_ref, principal, role, propagate=True, group=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_permission.set_ vm-100 alice@vsphere.local Admin
    """
    return c.set_(
        __opts__,
        entity_ref,
...
def remove(entity_ref, principal, group=False, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_permission.remove vm-100 alice@vsphere.local
    """
...
def reset(entity_ref, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_permission.reset vm-100
    """
