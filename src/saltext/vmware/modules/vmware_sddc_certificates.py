...
from saltext.vmware.clients import sddc_certificates as c

__virtualname__ = "vmware_sddc_certificates"
...
def list_(domain_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_certificates.list_ <domain_id>
...
def list_csrs(domain_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_certificates.list_csrs <domain_id>
...
def create_csrs(domain_id, csr_specs, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_certificates.create_csrs <domain_id> <csr_specs>
...
def install_certificates(domain_id, cert_specs, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_sddc_certificates.install_certificates <domain_id> <cert_specs>
