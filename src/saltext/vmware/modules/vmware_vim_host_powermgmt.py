...
def list_policies(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_powermgmt.list_policies <host>
...
def get_policy(host, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_powermgmt.get_policy <host>
...
def set_policy(host, policy_key, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_host_powermgmt.set_policy <host> <policy_key>
