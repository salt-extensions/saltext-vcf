...
from saltext.vmware.clients import vcfops_resource_group as c

__virtualname__ = "vmware_vcfops_resource_group"
...
def list_(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_resource_group.list_
...
def get(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_resource_group.get <group_id>
...
def create(group_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_resource_group.create <group_spec>
...
def update(group_id, group_spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_resource_group.update <group_id> <group_spec>
...
def delete(group_id, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vcfops_resource_group.delete <group_id>
