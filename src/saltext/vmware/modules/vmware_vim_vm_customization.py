...
from saltext.vmware.clients import vim_vm_customization as c

__virtualname__ = "vmware_vim_vm_customization"
...
def linux_spec(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_customization.linux_spec web-01 example.com nics='[{"dhcp": true}]'
    """
    return c.linux_spec(
        hostname,
        domain,
...
def windows_spec(
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_customization.windows_spec WIN-01 WORKGROUP admin_password='<pw>'
    """
...
def apply(vm, spec, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_customization.apply vm-100 <spec>
    """
...
def spec_list(profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_customization.spec_list
    """
...
def spec_delete(name, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vim_vm_customization.spec_delete linux-prod
    """
