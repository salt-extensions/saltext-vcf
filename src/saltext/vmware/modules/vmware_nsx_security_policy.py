...
def list_(domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_security_policy.list_ <domain>
...
def get(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_security_policy.get <policy> <domain>
...
def create(policy, domain="default", profile=None, **spec):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_security_policy.create <policy> <domain>
...
def delete(policy, domain="default", profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_nsx_security_policy.delete <policy> <domain>
