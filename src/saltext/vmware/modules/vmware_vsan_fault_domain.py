...
from saltext.vmware.clients import vsan_fault_domain as c

__virtualname__ = "vmware_vsan_fault_domain"
...
def list_(cluster, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vsan_fault_domain.list_ <cluster>
...
def assign(cluster, mapping, profile=None):
    ...
    .. code-block:: bash
        ...
        salt '*' vmware_vsan_fault_domain.assign <cluster> <mapping>
