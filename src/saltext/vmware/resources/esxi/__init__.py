...
use the cluster-level :mod:`saltext.vmware.modules.vmware_cluster_config`
...
from saltext.vmware.clients import esxi_host
from saltext.vmware.clients import esxi_ntp
from saltext.vmware.clients import esxi_service
from saltext.vmware.clients import esxi_syslog
...
def _opts():
    return {"pillar": {"saltext.vmware": {"esxi": _instance_cfg(_resource_id())}}}
