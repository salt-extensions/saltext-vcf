...
from saltext.vmware.clients import vim_dvs as dvs_c
from saltext.vmware.clients import vim_dvs_portgroup as pg_c
from saltext.vmware.states import vmware_vim_dvs as st
