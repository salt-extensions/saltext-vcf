...
from saltext.vcf.states import vcf_vcenter_supervisor_service as svc_state
from saltext.vcf.states import vcf_vcenter_vm_class as vmc_state
from saltext.vcf.states import vcf_vcf_services as vcfs_state
