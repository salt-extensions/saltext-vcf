...
from saltext.vmware.clients import vim_permission as perm_c
from saltext.vmware.clients import vim_role as role_c
from saltext.vmware.states import vmware_vim_permission as perm_state
from saltext.vmware.states import vmware_vim_role as role_state
