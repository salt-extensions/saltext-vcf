...
from saltext.vcf.clients import vcfops_alert as al_c
from saltext.vcf.clients import vcfops_auth as au_c
from saltext.vcf.clients import vcfops_collector as col_c
from saltext.vcf.clients import vcfops_credential as cr_c
from saltext.vcf.clients import vcfops_deployment as dep_c
from saltext.vcf.clients import vcfops_maintenance as mt_c
from saltext.vcf.clients import vcfops_recommendation as re_c
from saltext.vcf.clients import vcfops_report as rp_c
from saltext.vcf.clients import vcfops_resource_group as rg_c
from saltext.vcf.clients import vcfops_solution as so_c
from saltext.vcf.clients import vcfops_supermetric as sm_c
from saltext.vcf.clients import vcfops_task as ta_c
from saltext.vcf.modules import vcf_vcfops_alert as al_m
from saltext.vcf.modules import vcf_vcfops_auth as au_m
from saltext.vcf.modules import vcf_vcfops_collector as col_m
from saltext.vcf.modules import vcf_vcfops_credential as cr_m
from saltext.vcf.modules import vcf_vcfops_deployment as dep_m
from saltext.vcf.modules import vcf_vcfops_maintenance as mt_m
from saltext.vcf.modules import vcf_vcfops_recommendation as re_m
from saltext.vcf.modules import vcf_vcfops_report as rp_m
from saltext.vcf.modules import vcf_vcfops_resource_group as rg_m
from saltext.vcf.modules import vcf_vcfops_solution as so_m
from saltext.vcf.modules import vcf_vcfops_supermetric as sm_m
from saltext.vcf.modules import vcf_vcfops_task as ta_m
