...
from saltext.vcf.modules import vcf_vcenter_appliance
from saltext.vcf.modules import vcf_vcenter_datastore
from saltext.vcf.modules import vcf_vcenter_network
from saltext.vcf.modules import vcf_vcenter_storage_policy
...
def test_storage_policy_get(vcenter_authed):
    ...
    assert vcf_vcenter_storage_policy.get("p-1")["name"] == "n"
...
def test_appliance_version(vcenter_authed):
    ...
    assert vcf_vcenter_appliance.version() == {"product": "vCenter"}
...
def test_appliance_services_start(vcenter_authed):
    ...
    vcf_vcenter_appliance.services_start("vsphere-ui")
