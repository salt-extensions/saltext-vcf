...
not against the SLS file's own directory. So when you copy this `examples/`
...
for the import to resolve — copy the whole `examples/` folder as one unit,
...
1. Copy `examples/states/*` and `examples/templates/*` onto your Salt
